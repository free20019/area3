					...
					<div class="widget-body no-padding">
						<form action="" id="msg-form" class="smart-form" novalidate="novalidate" >
								<section style="width:180px;float:left;">
									...
									<label class="select">
										<select  id="allloadcomp" class="select">
		...
		success:function(data){	
			...
			if(list.length<=1){
				for(var i=0;i<list.length;i++){
					$('#allloadcomp').append("<option value='"+list[i].baid+"'>"+list[i].name+"</option>");
				}
			}else{
				$("#allloadcomp").append("<option value='0' >--选择公司--</option>");
				for(var i=0;i<list.length;i++){
					$('#allloadcomp').append("<option value='"+list[i].baid+"'>"+list[i].name+"</option>");
				}
			}
		...
		$.ajax({
			...
			success:function(json){
					...
					if(i==0){
						...
						var day1=[];
								day1.push("["+j);
								day1.push(aa[0][i].substring(0,aa[0][i].length-1)+"]");
							daynq.push(day1);
					}
					...
					if(i==0){
						...
						var day1=[];
								day1.push("["+j);
								day1.push(bb[0][i].substring(0,bb[0][i].length-1)+"]");
							dayyq.push(day1);
					}
					...
					if(i==0){
						...
						var day1=[];
								day1.push("["+j);
								day1.push(cc[0][i].substring(0,cc[0][i].length-1)+"]");
							daysq.push(day1);
						}
					}
					...
					if(i==0){
						...
						var day1=[];
								day1.push("["+j);
								day1.push(dd[0][i].substring(0,dd[0][i].length-1)+"]");
							dayqq.push(day1);
					}
					...
					if(i==0){
						...
						var day1=[];
								day1.push("["+j);
								day1.push(ee[0][i].substring(0,ee[0][i].length-1)+"]");
							dayzq.push(day1);
					}
					...
					if(i==0){
						...
						var day1=[];
								day1.push("["+j);
								day1.push(ff[0][i].substring(0,ff[0][i].length-1)+"]");
							dayjq.push(day1);
					}
