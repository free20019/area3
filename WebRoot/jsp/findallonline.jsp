					...
					<div class="widget-body no-padding">
						<form action="" id="msg-form" class="smart-form" novalidate="novalidate" >
								<section style="width:180px;float:left;">
									...
									<label class="select">
										<select  id="allonlinecomp" class="select">
			...
			success:function(data){	
				...
				if(list.length<=1){
					for(var i=0;i<list.length;i++){
						$('#allonlinecomp').append("<option value='"+list[i].baid+"'>"+list[i].name+"</option>");
					}
				}else{
					$("#allonlinecomp").append("<option value='0' >--选择公司--</option>");
					for(var i=0;i<list.length;i++){
						$('#allonlinecomp').append("<option value='"+list[i].baid+"'>"+list[i].name+"</option>");
					}
				}
		...
		$.ajax({
			...
			success:function(json){
					...
					if(i==0){
						...
						var gps1=[];
						gps1.push("["+j);
						gps1.push(aa[2][i].substring(0,aa[2][i].length-1)+"]" );
						gpsnq.push(gps1);
					}
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(bb[2][i].substring(0,bb[2][i].length-1)+"]" );
							gpsyq.push(gps1);
					}
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(cc[2][i].substring(0,cc[2][i].length-1)+"]" );
							gpssq.push(gps1);
					}
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(dd[2][i].substring(0,dd[2][i].length-1)+"]" );
							gpsqq.push(gps1);
					}
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(ee[2][i].substring(0,ee[2][i].length-1)+"]" );
							gpszq.push(gps1);
					}
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(ff[2][i].substring(0,ff[2][i].length-1)+"]" );
							gpsjq.push(gps1);
					}
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(gg[i].substring(0,gg[i].length-1)+"]");
							gpspq.push(gps1);
					}
					if(hh!=null){
					for(var i=0;i<hh.length;i++){
