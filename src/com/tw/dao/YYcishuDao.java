...
public class YYcishuDao {
	public double findmeiyou(int i){
		...
		try {
			...
			rs=ps.executeQuery();
			if (rs.next()) {
				BigDecimal  b4   =   new   BigDecimal(rs.getDouble("c")/a+"");  
