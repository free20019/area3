				...
				<div>
					...
					<div class="widget-body no-padding">
						<form action="" id="msg-form" class="smart-form" novalidate="novalidate" >
								<a href="javascript:void(0);" id="sck" style="display: none;" class="btn btn-primary" onclick="stationfind();">查   看</a>
								<a href="javascript:void(0);" id="sxz" style="display: none;" class="btn btn-primary" onclick="setstation();">新   增</a>
								<a href="javascript:void(0);" id="sxg" style="display: none;" class="btn btn-primary" onclick="stationedit();">修   改</a>
								<a href="javascript:void(0);" id="ssc" style="display: none;" class="btn btn-primary" onclick="delstation();">删   除</a>
						</form>
						...
						<table>
							<tr>
								<td width="250"><div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="yemian" value="重点监控区域车辆分析"><i></i>重点监控区域车辆分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="重点监控区域车辆明细"><i></i>重点监控区域车辆明细</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="重点监控区域时段停留车辆"><i></i>重点监控区域时段停留车辆</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="重点监控区域上线率分析"><i></i>重点监控区域上线率分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="重点监控区域重车率分析"><i></i>重点监控区域重车率分析</label>
									...
									<label class="checkbox"><input type="checkbox" name="yemian" value="单车平均空驶里程分析"><i></i>单车平均空驶里程分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="单车平均行驶总里程分析"><i></i>单车平均行驶总里程分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="单车平均营运次数分析"><i></i>单车平均营运次数分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="单车平均载客时间分析"><i></i>单车平均载客时间分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="单车平均载客等候时间分析"><i></i>单车平均载客等候时间分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="营运态势(图例)"><i></i>营运态势(图例)</label>
									</div>
								</td>
								<td width="200"><div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="yemian" value="营运记录查询"><i></i>营运记录查询</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="群组营运记录查询"><i></i>群组营运记录查询</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="车辆营运数据统计"><i></i>车辆营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="业户营运数据统计"><i></i>业户营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="群组营运数据统计"><i></i>群组营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="从业人员营运数据统计"><i></i>从业人员营运数据统计</label>
									...
									<label class="checkbox"><input type="checkbox" name="yemian" value="单车速度曲线及里程统计"><i></i>单车速度曲线及里程统计</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="业户车辆营运情况分析"><i></i>业户车辆营运情况分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="在线营运率分析"><i></i>在线营运率分析</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="上下客监测点车辆查询"><i></i>上下客监测点车辆查询</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="营运态势"><i></i>营运态势</label>
									</div>
								</td>
								<td width="149"><div class="col col-4">
									...
									<label class="checkbox"><input type="checkbox" name="yemian" value="停留车辆监控"><i></i>停留车辆监控</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="实载率分析"><i></i>实载率分析</label>
									...
									<label class="checkbox"><input type="checkbox" name="yemian" value="营运年报(月)"><i></i>营运年报(月)</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="营运年报(季)"><i></i>营运年报(季)</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="营运逐年报"><i></i>营运逐年报</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="实时监控"><i></i>实时监控</label>
									<label class="checkbox"><input type="checkbox" name="yemian" value="终端类型营运数据统计"><i></i>终端类型营运数据统计</label>
									</div>
								</td>
							</tr>
						</table>
			...
			<input name="authenticity_token" type="hidden">
					<label class="label"><font color="black" size="2px">页面权限:</font></label>
						<table>
							<tr>
								<td width="250"><div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="重点监控区域车辆分析"><i></i>重点监控区域车辆分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="重点监控区域车辆明细"><i></i>重点监控区域车辆明细</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="重点监控区域时段停留车辆"><i></i>重点监控区域时段停留车辆</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="重点监控区域上线率分析"><i></i>重点监控区域上线率分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="重点监控区域重车率分析"><i></i>重点监控区域重车率分析</label>
									...
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="单车平均空驶里程分析"><i></i>单车平均空驶里程分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="单车平均行驶总里程分析"><i></i>单车平均行驶总里程分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="单车平均营运次数分析"><i></i>单车平均营运次数分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="单车平均载客时间分析"><i></i>单车平均载客时间分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="单车平均载客等候时间分析"><i></i>单车平均载客等候时间分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="营运态势(图例)"><i></i>营运态势(图例)</label>
									</div>
								</td>
								<td width="200"><div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="营运记录查询"><i></i>营运记录查询</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="群组营运记录查询"><i></i>群组营运记录查询</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="车辆营运数据统计"><i></i>车辆营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="业户营运数据统计"><i></i>业户营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="群组营运数据统计"><i></i>群组营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="从业人员营运数据统计"><i></i>从业人员营运数据统计</label>
									...
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="单车速度曲线及里程统计"><i></i>单车速度曲线及里程统计</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="业户车辆营运情况分析"><i></i>业户车辆营运情况分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="在线营运率分析"><i></i>在线营运率分析</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="上下客监测点车辆查询"><i></i>上下客监测点车辆查询</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="营运态势"><i></i>营运态势</label>
									</div>
								</td>
								<td width="149"><div class="col col-4">
									...
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="停留车辆监控"><i></i>停留车辆监控</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="实载率分析"><i></i>实载率分析</label>
									...
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="营运年报(月)"><i></i>营运年报(月)</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="营运年报(季)"><i></i>营运年报(季)</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="营运逐年报"><i></i>营运逐年报</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="实时监控"><i></i>实时监控</label>
									<label class="checkbox"><input type="checkbox" name="cxyemian" value="终端类型营运数据统计"><i></i>终端类型营运数据统计</label>
									</div>
								</td>
							</tr>
						</table>
			...
			<input name="authenticity_token" type="hidden">
					<label class="label"><font color="black" size="2px">页面权限:</font></label>
						<table>
							<tr>
								<td width="250"><div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="重点监控区域车辆分析"><i></i>重点监控区域车辆分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="重点监控区域车辆明细"><i></i>重点监控区域车辆明细</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="重点监控区域时段停留车辆"><i></i>重点监控区域时段停留车辆</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="重点监控区域上线率分析"><i></i>重点监控区域上线率分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="重点监控区域重车率分析"><i></i>重点监控区域重车率分析</label>
									...
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="单车平均空驶里程分析"><i></i>单车平均空驶里程分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="单车平均行驶总里程分析"><i></i>单车平均行驶总里程分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="单车平均营运次数分析"><i></i>单车平均营运次数分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="单车平均载客时间分析"><i></i>单车平均载客时间分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="单车平均载客等候时间分析"><i></i>单车平均载客等候时间分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="营运态势(图例)"><i></i>营运态势(图例)</label>
									</div>
								</td>
								<td width="200"><div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="营运记录查询"><i></i>营运记录查询</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="群组营运记录查询"><i></i>群组营运记录查询</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="车辆营运数据统计"><i></i>车辆营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="业户营运数据统计"><i></i>业户营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="群组营运数据统计"><i></i>群组营运数据统计</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="从业人员营运数据统计"><i></i>从业人员营运数据统计</label>
									...
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="单车速度曲线及里程统计"><i></i>单车速度曲线及里程统计</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="业户车辆营运情况分析"><i></i>业户车辆营运情况分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="在线营运率分析"><i></i>在线营运率分析</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="上下客监测点车辆查询"><i></i>上下客监测点车辆查询</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="营运态势"><i></i>营运态势</label>
									</div>
								</td>
								<td width="149"><div class="col col-4">
									...
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="停留车辆监控"><i></i>停留车辆监控</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="实载率分析"><i></i>实载率分析</label>
									...
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="营运年报(月)"><i></i>营运年报(月)</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="营运年报(季)"><i></i>营运年报(季)</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="营运逐年报"><i></i>营运逐年报</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="实时监控"><i></i>实时监控</label>
									<label class="checkbox"><input type="checkbox" name="xgyemian" value="终端类型营运数据统计"><i></i>终端类型营运数据统计</label>
									</div>
								</td>
							</tr>
						</table>
