		...
		$.ajax({
			...
			success:function(json){
					...
					var j=i+1;
						...
						var yy1=[];
								yy1.push( "["+j);
								yy1.push(aa[i].run_rate.substring(0,aa[i].run_rate.length-1)+"]");
							yingyunn.push(yy1);
						}
					}
					for(var i=0;i<bb.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push( "["+j);
								yy1.push(bb[i].run_rate.substring(0,bb[i].run_rate.length-1)+"]");
							yingyuny.push(yy1);
						}
					}
					for(var i=0;i<cc.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push( "["+j);
								yy1.push(cc[i].run_rate.substring(0,cc[i].run_rate.length-1)+"]");
							yingyuns.push(yy1);
						}
					}
					for(var i=0;i<dd.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push( "["+j);
								yy1.push(dd[i].run_rate.substring(0,dd[i].run_rate.length-1)+"]");
							yingyunq.push(yy1);
						}
					}
					for(var i=0;i<ee.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push( "["+j);
								yy1.push(ee[i].run_rate.substring(0,ee[i].run_rate.length-1)+"]");
							yingyunz.push(yy1);
						}
					}
					if(ff.length>20){
					...
					var j=i+1;
						...
						var yy1=[];
								yy1.push( "["+j);
								yy1.push(ff[i].run_rate.substring(0,ff[i].run_rate.length-1)+"]");
							yingyunj.push(yy1);
						}
					}
					}else{
						...
						for(var i=0;i<hh.length;i++){
							...
							var yy1=[];
									yy1.push( "["+j);
									yy1.push(hh[i].substring(0,hh[i].length-1)+"]");
								yingyunj.push(yy1);
							}
						}
					}
					...
					var j=i+1;
						...
						var yy1=[];
								yy1.push( "["+j);
								yy1.push(gg[i].substring(0,gg[i].length-1)+"]");
							yingyunp.push(yy1);
						}
					}
					if(ii!=null){
					...
					var j=i+1;
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(jj[i].substring(0,jj[i].length-1)+"]" );
