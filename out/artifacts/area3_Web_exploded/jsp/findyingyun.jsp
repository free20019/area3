		...
		$.ajax({
			...
			success:function(json){
					...
					var j=i+1;
						...
						var yy1=[];
								yy1.push("["+j);
								yy1.push(aa[i].substring(0,aa[i].length-1)+"]");
							yingyunn.push(yy1);
						}
					}
					for(var i=0;i<bb.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push("["+j);
								yy1.push(bb[i].substring(0,bb[i].length-1)+"]");
							yingyuny.push(yy1);
						}
					}
					for(var i=0;i<cc.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push("["+j);
								yy1.push(cc[i].substring(0,cc[i].length-1)+"]");
							yingyuns.push(yy1);
						}
					}
					for(var i=0;i<dd.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push("["+j);
								yy1.push(dd[i].substring(0,dd[i].length-1)+"]");
							yingyunq.push(yy1);
						}
					}
					for(var i=0;i<ee.length;i++){
					var j=i+1;
						...
						var yy1=[];
								yy1.push("["+j);
								yy1.push(ee[i].substring(0,ee[i].length-1)+"]");
							yingyunz.push(yy1);
						}
					}
					...
					if(ff[i].length>5){
						...
						var yy1=[];
								yy1.push("["+j);
								yy1.push(ff[i].substring(0,ff[i].length-1)+"]");
							yingyunj.push(yy1);
						}
					}
					for(var i=0;i<gg.length;i++){
