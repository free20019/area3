	...
	<tr style="height: ;overflow: auto;">
		<td>
			...
			<header style = "text-align:left;">
				...
				<div id="dayfxtb" class="chart has-legend"></div>
			</div>
		</td>
	</tr>
</table>
			...
			success:function(json){
				...
				if(fx!=null){
					for(i=0;i<fx.length;i++){
						time.push(fx[i].time.substr(5,5));
						...
						$("#ynmrtbody").html(tab);
						dayfxtb(time,hangzhou,dahangzhou,zhejiang,henan,anhui,jiangxi)
	$.unblockUI();
				}
			},
			error:function(){
...
function dayfxtb(time,hangzhou,dahangzhou,zhejiang,henan,anhui,jiangxi){
	  // 使用
   require(
      [
          'echarts',
      ...
      function (ec) {
          ...
          var myChart = ec.init(document.getElementById('dayfxtb')); 
