...
<link rel="stylesheet" type="text/css" media="screen" href="/area3/bootstrap.min.css">
<link rel="stylesheet" type="text/css" media="screen" href="/area3/map.css">
				...
				<div>
					...
					<div class="widget-body no-padding">
						<form action="" id="msg-form" class="smart-form" novalidate="novalidate" >
								...
								<label class="select">
									<select  id="cardNo3" class="select">
										<option value="0" >--选择车号--</option>
									</select> <i></i> 
								</label>
								</section>
								<section class="col col-5" style="width: 110px;float:left;" >
									<input type="text" style="width: 110px;height: 28px;color:gray" id="test3" placeholder="查找车号"/>
									</section>
								<a href="javascript:void(0);" id ="search3" class="btn btn-primary" data-url="business.action" data-msg="business">查   询</a>
