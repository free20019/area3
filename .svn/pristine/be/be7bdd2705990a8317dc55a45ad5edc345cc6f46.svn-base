				...
				<div>
					...
					<div class="widget-body no-padding">
						<form action="" id="msg-form" class="smart-form" novalidate="novalidate" >
									...
									<label class="select">
										<select  id="onlinecomp" class="select">
		...
		success:function(data){	
			...
			if(list.length<=1){
				for(var i=0;i<list.length;i++){
					$('#onlinecomp').append("<option value='"+list[i].baid+"'>"+list[i].name+"</option>");
				}
			}else{
				$("#onlinecomp").append("<option value='0' >--选择公司--</option>");
				for(var i=0;i<list.length;i++){
					$('#onlinecomp').append("<option value='"+list[i].baid+"'>"+list[i].name+"</option>");
				}
			}
		...
		$.ajax({
			...
			success:function(json){
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(aa[3][i].substring(0,aa[3][i].length-1)+"]" );
							gpsnj.push(gps1);
					}
					for(var i=0;i<bb[3].length;i++){
					var j=0;
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(bb[3][i].substring(0,bb[3][i].length-1)+"]" );
							gpsyj.push(gps1);
					}
					for(var i=0;i<cc[3].length;i++){
					var j=0;
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(cc[3][i].substring(0,cc[3][i].length-1)+"]" );
							gpssj.push(gps1);
						}
					}
					for(var i=0;i<dd[3].length;i++){
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(dd[3][i].substring(0,dd[3][i].length-1)+"]" );
							gpsqj.push(gps1);
						}
					}
					for(var i=0;i<ee[3].length;i++){
					...
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(ee[3][i].substring(0,ee[3][i].length-1)+"]" );
							gpszj.push(gps1);
					}
					for(var i=0;i<ff[3].length;i++){
					var j=0;
					if(i==0){
						...
						var gps1=[];
								gps1.push("["+j);
								gps1.push(ff[3][i].substring(0,ff[3][i].length-1)+"]" );
							gpsjj.push(gps1);
						}
					}
					for(var i=0;i<gg.length;i++){
