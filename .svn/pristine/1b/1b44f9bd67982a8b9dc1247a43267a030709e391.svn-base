...
public class LoadOnlineDAO {
	public String[][] findloadonline(String time,int i,String baid){
		...
		String sql="select * from TB_TAXI_LOAD_ONLINE_RATE t where" +
				...
				" db_time<=to_date('"+d+" 23:59:59','yyyy-MM-dd HH24:mi:ss') " +
				"and ba_id = '"+baid+"' order by db_time";
...
//						}
	...
	//平均值
	public List<LOADONLINE>findaverage(String time,String baid){
		...
		String sql="select * from TB_TAXI_LOAD_ONLINE_RATE t where db_time>=to_date('"+st+"','yyyy-MM-dd HH24:mi:ss')" +
				" and db_time<=to_date('"+et+"','yyyy-MM-dd HH24:mi:ss') and ba_id = '"+baid+"'";
		try {
			Connection con=DataBese.getConnectionOfOracle();
			PreparedStatement ps=con.prepareStatement(sql);
			ResultSet rs=ps.executeQuery();
