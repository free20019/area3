	...
	<tr style="height: ;overflow: auto;">
		<td>
			...
			<header style = "text-align:left;">
					...
					<h2 id="zdqyrtj">杭州出租车重点区域服务车次(每日统计)</h2>
				</header>
				<!-- widget div-->
				<div>
				...
				<div id="zdqyrtjtb" class="chart has-legend"></div>
			</div>
		</td>
	</tr>
</table>
			...
			success:function(json){
				...
				if(fx!=null){
					for(i=0;i<fx.length;i++){
						...
						zdqyrtjtb(time1,beizhan,xizhan,jichang,dongzhan,chengzhan,keyun,nanzhan)
	$.unblockUI();
				}
			},
			error:function(){
...
function zdqyrtjtb(time1,beizhan,xizhan,jichang,dongzhan,chengzhan,keyun,nanzhan){
	  // 使用
   require(
      [
          'echarts',
      ...
      function (ec) {
          ...
          var myChart = ec.init(document.getElementById('zdqyrtjtb')); 
...
$("#zdqyrtj").html("杭州出租车重点区域服务车次(每日统计)");
//树
